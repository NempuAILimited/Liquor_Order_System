// ========================
// Type definitions for Liquor Order System
// ========================
...
export interface LiquorItem {
  ...
  size: BottleSize;
  pricePerUnit: number;       // MRP in INR
  exciseDuty: number;         // Excise duty per unit in INR
...
export interface CartItem {
  ...
  quantity: number;            // number of cases
  unitsPerCase: number;        // bottles per case (usually 12 or 24)
  totalBottles: number;
  totalAmount: number;
  exciseAmount: number;
}
